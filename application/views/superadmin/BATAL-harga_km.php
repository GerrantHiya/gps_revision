<div class="container">
    ...
    <div class="modal fade" id="ubah" tabindex="-1" aria-labelledby="UbahHarga" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content" action="<?= base_url('superadmin/ubah_harga_km') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <a href="<?= base_url('superadmin/harga-jarak') ?>" class="btn btn-warning">reset</a>
    ...
    <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="TambahHarga" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content" action="<?= base_url('superadmin/tambah_harga_km') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-header">
                    ...
                    <div class="row pt-3 mb-3">
                        <div class="col">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <div class="input-group-prepend">
                                    <label for="bbawah" class="input-group-text"><b>Meter</b></label>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <div class="input-group-prepend">
                                    <label for="batas" class="input-group-text"><b>Meter</b></label>
                                </div>
                            </div>
    ...
    <table class="table table-hover text-center">
        <thead>
            <tr>
                ...
                <th scope="col" class="">Harga (/km)</th>
        ...
        <tbody>
            <?php if (!empty($list_harga)) { ?>
                <?php foreach ($list_harga as $harga) : ?>
                    <tr>
                        <td><?= $nomor++ ?></td> <!-- Nomor -->
                        <td class="col-2">lowest: <?= $harga['range_low'] ?> km</td> <!-- Low -->
                        <td class="col-2">highest: <?= $harga['range_high'] ?> km</td> <!-- High -->
