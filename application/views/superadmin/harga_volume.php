<div class="container">
    ...
    <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="TambahHarga" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content" action="<?= base_url('superadmin/tambah_harga_volume') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row pt-3 mb-3">
                        <div class="col">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <div class="input-group-prepend">
                                    <label for="bbawah" class="input-group-text"><b>cm<sup>3</sup></b></label>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <div class="input-group-prepend">
                                    <label for="batas" class="input-group-text"><b>cm<sup>3</sup></b></label>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control rounded-0" id="harga_display" placeholder="Harga per Meter Kubik">
                ...
                <div class="modal-footer">
                    <a href="<?= base_url('superadmin/harga-volume') ?>" class="btn btn-warning">reset</a>
    ...
    <table class="table table-hover text-center">
        <thead>
            <tr>
                ...
                <th scope="col" class="" colspan="2">Range Volume</th>
                <th scope="col" class="">Harga (/m<sup>3</sup>)</th>
        ...
        <tbody>
            <?php if (!empty($list_harga)) { ?>
                <?php foreach ($list_harga as $harga) : ?>
                    <tr>
                        <td><?= $nomor++ ?></td> <!-- Nomor -->
                        <td class="col-3">lowest: <?= $harga['range_low_format'] ?> cm<sup>3</sup></td> <!-- Low -->
                        <td class="col-3">highest: <?= $harga['range_high_format'] ?> cm<sup>3</sup></td> <!-- High -->
