...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; <?= date('Y') ?> <a href="https://gerranthiya.e-digital.space/">Gerrant Hiya</a> | All rights reserved.</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<!-- Created & Design by Gerrant E Hiya | Professional IT Developer -->
</body>
