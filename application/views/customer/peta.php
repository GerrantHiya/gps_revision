<div class="mb-4" id="map-div">
    <div class="row">
        <div class="col">
            <a href="<?= base_url('customer/lacak-pengiriman') ?>" class="badge badge-secondary mb-3">&laquo; kembali</a>
            <a href="<?= base_url('customer/lacak-pengiriman-detail/' . $resi_md5) ?>" class="badge badge-info">refresh</a>
        </div>
        <div class="col"></div>
        <div class="col">
